...
export const DIVISIONS = [
  {
    ...
    categories: [
      { id: 'GAR-CAT-01', name: 'Shirts', slug: 'shirts', status: 'active' as const, displayOrder: 1, image: '/images/formal-shirts.png', subCategories: [] },
      { id: 'GAR-CAT-02', name: 'T-Shirts', slug: 't-shirts', status: 'active' as const, displayOrder: 2, image: '/images/polo tshirts.png', subCategories: [] },
      { id: 'GAR-CAT-03', name: 'Jeans', slug: 'jeans', status: 'active' as const, displayOrder: 3, image: '/images/jeans-denims.png', subCategories: [] },
      { id: 'GAR-CAT-04', name: 'Trousers', slug: 'trousers', status: 'active' as const, displayOrder: 4, image: '/images/trousers.png', subCategories: [] },
      { id: 'GAR-CAT-05', name: 'Cargos', slug: 'cargos', status: 'active' as const, displayOrder: 5, image: '/images/products/cargo_work_pants.png', subCategories: [] },
      { id: 'GAR-CAT-06', name: 'Track Pants', slug: 'track-pants', status: 'active' as const, displayOrder: 6, image: '/images/Blazers and suits.png', subCategories: [] },
    ],
  },

  {
    ...
    metaTitle: 'Hometra B2B Kitchenware & Cookware Supplier UAE | Triply Cookware, Cutlery, Storage — WCC Fashions',
    ...
    keywords: ['Hometra UAE', 'wholesale kitchenware Dubai', 'triply cookware bulk order', 'cutlery supplier UAE', 'wooden serveware wholesale', 'kitchen organizers bulk Dubai', 'B2B home essentials UAE', 'hotel kitchenware supplier Middle East'],
    heroHeading: 'Premium Cookware & Kitchen Essentials at Scale.',
    heroSubtitle: 'Triply stainless steel cookware, premium cutlery, artisan wood serveware, and smart organizers — manufactured in collaboration with Hometra.',
    stat1Label: 'MOQ From', stat1Value: '100 Units',
    stat2Label: 'Lead Time', stat2Value: '10–20 Days',
    stat3Label: 'Brand Partner', stat3Value: 'Hometra',
    categories: [
      { id: 'HH-CAT-01', name: 'Triply Cookware', slug: 'cookware', status: 'active' as const, displayOrder: 1, image: '/images/hh-1.png', subCategories: [] },
      { id: 'HH-CAT-02', name: 'Premium Cutlery', slug: 'cutlery', status: 'active' as const, displayOrder: 2, image: '/images/hh-2.png', subCategories: [] },
      { id: 'HH-CAT-03', name: 'Table & Serveware', slug: 'table-top', status: 'active' as const, displayOrder: 3, image: '/images/hh-3.png', subCategories: [] },
      { id: 'HH-CAT-04', name: 'Storage & Organizer', slug: 'utility', status: 'active' as const, displayOrder: 4, image: '/images/hh-4.png', subCategories: [] },
    ],
  },

  {
    ...
    categories: [
      { id: 'HOS-CAT-07', name: 'Barware Products', slug: 'barware', status: 'active' as const, displayOrder: 1, image: '/images/hos-1.png', subCategories: [] },
      { id: 'HOS-CAT-08', name: 'Cookware Products', slug: 'cookware', status: 'active' as const, displayOrder: 2, image: '/images/hos-2.png', subCategories: [] },
...

  {
    ...
    categories: [
      { id: 'UNI-CAT-01', name: 'Corporate Workwear', slug: 'corporate-workwear', status: 'active' as const, displayOrder: 1, image: '/images/uniform-workwear.png', subCategories: [] },
      { id: 'UNI-CAT-02', name: 'Security Attire', slug: 'security-attire', status: 'active' as const, displayOrder: 2, image: '/images/uniform-workwear.png', subCategories: [] },
      { id: 'UNI-CAT-03', name: 'Industrial & PPE', slug: 'industrial-ppe', status: 'active' as const, displayOrder: 3, image: '/images/uniform-workwear.png', subCategories: [] },
      { id: 'UNI-CAT-04', name: 'Chef & Kitchen Wear', slug: 'chef-kitchen-wear', status: 'active' as const, displayOrder: 4, image: '/images/uniform-workwear.png', subCategories: [] },
      { id: 'UNI-CAT-05', name: 'Protective Aprons', slug: 'protective-aprons', status: 'active' as const, displayOrder: 5, image: '/images/uniform-workwear.png', subCategories: [] },
      { id: 'UNI-CAT-06', name: 'Medical & Scrubs', slug: 'medical-scrubs', status: 'coming-soon' as const, displayOrder: 6, image: '/images/uniform-workwear.png', subCategories: [] },
    ],
  },

  {
    ...
    categories: [
      {
        id: 'HOME-CAT-01', name: 'Bedsheets', slug: 'bedsheets', status: 'active' as const, displayOrder: 1, image: '/images/home furnishing.png',
        subCategories: [
          { id: 'HOME-SUB-01', name: 'Fitted Sheets', slug: 'fitted-sheets', status: 'active' as const, displayOrder: 1, image: '' },
          { id: 'HOME-SUB-02', name: 'Flat Sheets', slug: 'flat-sheets', status: 'active' as const, displayOrder: 2, image: '' },
          { id: 'HOME-SUB-03', name: 'Pillow Covers', slug: 'pillow-covers', status: 'active' as const, displayOrder: 3, image: '' },
        ],
      },
      {
        id: 'HOME-CAT-02', name: 'Bath Textiles', slug: 'bath-textiles', status: 'active' as const, displayOrder: 2, image: '/images/home furnishing.png',
        subCategories: [
          { id: 'HOME-SUB-04', name: 'Bath Towels', slug: 'bath-towels', status: 'active' as const, displayOrder: 1, image: '' },
          { id: 'HOME-SUB-05', name: 'Hand Towels', slug: 'hand-towels', status: 'active' as const, displayOrder: 2, image: '' },
          { id: 'HOME-SUB-06', name: 'Bath Sheets', slug: 'bath-sheets', status: 'active' as const, displayOrder: 3, image: '' },
        ],
      },
      {
        id: 'HOME-CAT-03', name: 'Luxury Throws', slug: 'luxury-throws', status: 'active' as const, displayOrder: 3, image: '/images/home furnishing.png',
        subCategories: [
          { id: 'HOME-SUB-07', name: 'Cashmere Throws', slug: 'cashmere-throws', status: 'active' as const, displayOrder: 1, image: '' },
          { id: 'HOME-SUB-08', name: 'Merino Wool Blankets', slug: 'merino-blankets', status: 'active' as const, displayOrder: 2, image: '' },
        ],
      },
      {
        id: 'HOME-CAT-04', name: 'Table Linen', slug: 'table-linen', status: 'coming-soon' as const, displayOrder: 4, image: '/images/home furnishing.png',
        subCategories: [
          { id: 'HOME-SUB-09', name: 'Table Runners', slug: 'table-runners', status: 'coming-soon' as const, displayOrder: 1, image: '' },
          { id: 'HOME-SUB-10', name: 'Placemats', slug: 'placemats', status: 'coming-soon' as const, displayOrder: 2, image: '' },
        ],
      },
    ],
  },

  {
    ...
    categories: [
      { id: 'FRA-CAT-01', name: 'Arabian Oud', slug: 'arabian-oud', status: 'active' as const, displayOrder: 1, image: '/images/perfume-bg.png', subCategories: [] },
      { id: 'FRA-CAT-02', name: 'Bakhoor & Incense', slug: 'bakhoor-incense', status: 'active' as const, displayOrder: 2, image: '/images/perfume-bg.png', subCategories: [] },
      { id: 'FRA-CAT-03', name: 'Eau de Parfum', slug: 'eau-de-parfum', status: 'active' as const, displayOrder: 3, image: '/images/perfume-bg.png', subCategories: [] },
      { id: 'FRA-CAT-04', name: 'Private Label', slug: 'private-label', status: 'active' as const, displayOrder: 4, image: '/images/perfume-bg.png', subCategories: [] },
      { id: 'FRA-CAT-05', name: 'Raw Materials', slug: 'raw-materials', status: 'coming-soon' as const, displayOrder: 5, image: '/images/perfume-bg.png', subCategories: [] },
    ],
  },
]
...
export const MOCK_PRODUCTS: Array<{
  ...
  brand_slug?: string | null
    ...
    },
    {
      ...
      is_new: true, is_offer: false, offer_label: null, featured: true,
      specifications: { material: '18/10 Stainless Steel', finish: 'Hammered Silver', pieces: '24 Pcs with Stand', brand: 'Hometra' },
    ...
    },
    {
      ...
      specifications: { material: 'Acacia Wood & Tempered Glass', compartments: '4 Compartments', finish: 'Natural Polished', brand: 'Hometra' },
    ...
    },
    {
      ...
      specifications: { material: '18/10 Stainless Steel', pieces: '17 Pcs Set', brand: 'Hometra', sku: 'MI-5072-H', features: 'Ergonomic handles, induction compatible' },
    ...
    },
    {
      ...
      specifications: { material: '18/10 Stainless Steel', pieces: '3 Pcs Set', brand: 'Hometra', sku: 'MI-5068-H', features: 'Encapsulated core, mirror finish' },
...
export const MOCK_BRANDS = [
  ...
  },
  {
    ...
    logo_mobile: '/images/logo/hometra.png',
    logo_desktop: '/images/logo/hometra.png',
    featured: true,
    display_order: 5,
    created_at: '2026-01-01T00:00:00Z'
  }
